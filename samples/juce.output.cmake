...
set(
  JUCE_MODULES_DIR "${JUCE_SOURCE_DIR}/modules"
  CACHE
  INTERNAL "The path to JUCE modules"
)
...
cmake_dependent_option(
  JUCE_ENABLE_MODULE_SOURCE_GROUPS "Show all module sources in IDE projects"
  OFF "NOT JUCE_MODULES_ONLY"
  OFF
)
...
option(
  ...
  "Whether or not plugins should be installed to the system after building"
  OFF
)
set_property(
  GLOBAL
  PROPERTY
  JUCE_COPY_PLUGIN_AFTER_BUILD ${JUCE_COPY_PLUGIN_AFTER_BUILD}
)
...
option(
  JUCE_BUILD_EXTRAS "Add build targets for the Projucer and other tools"
  OFF
)
...
write_basic_package_version_file(
  "${JUCE_BINARY_DIR}/JUCEConfigVersion.cmake"
  VERSION ${JUCE_VERSION}
  COMPATIBILITY ExactVersion ${extra_version_arg}
)

set(
  JUCE_INSTALL_DESTINATION "lib/cmake/JUCE-${JUCE_VERSION}"
  CACHE
  STRING
...
configure_package_config_file(
  "${JUCE_CMAKE_UTILS_DIR}/JUCEConfig.cmake.in"
...
if(("${CMAKE_SOURCE_DIR}" STREQUAL "${JUCE_SOURCE_DIR}") AND (NOT JUCE_BUILD_HELPER_TOOLS))
  ...
  if(TARGET juce_lv2_helper)
    install(
      TARGETS juce_lv2_helper
      EXPORT
      LV2_HELPER
      DESTINATION "bin/JUCE-${JUCE_VERSION}"
    )
    install(
      EXPORT
      LV2_HELPER

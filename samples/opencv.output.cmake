...
if(NOT OPENCV_SKIP_CMAKE_SYSTEM_FILE)
  include(
    "cmake/platforms/OpenCV-${CMAKE_SYSTEM_NAME}.cmake"
    OPTIONAL
    RESULT_VARIABLE "OPENCV_CMAKE_SYSTEM_FILE"
  )
  if(NOT OPENCV_CMAKE_SYSTEM_FILE)
    message(
      STATUS
      "OpenCV: system-specific configuration file is not found: '${CMAKE_SYSTEM_NAME}'"
    )
  endif()
endif()
...
set(
  BUILD_LIST ""
  CACHE
  STRING "Build only listed modules (comma-separated, e.g. 'videoio,dnn,ts')"
)
...
# 3rd party libs
OCV_OPTION(
  OPENCV_FORCE_3RDPARTY_BUILD "Force using 3rdparty code from source"
  OFF
)
OCV_OPTION(
...
OCV_OPTION(
  BUILD_OPENJPEG "Build OpenJPEG from source" (
  WIN32
  OR
  ANDROID
  OR
...
# ===================================================
OCV_OPTION(
  WITH_1394 "Include IEEE1394 support"
  ON
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_AVFOUNDATION "Use AVFoundation for Video I/O (iOS/Mac)"
  ON
  VISIBLE_IF
  APPLE
  VERIFY
...
OCV_OPTION(WITH_AVIF "Enable AVIF support" OFF VERIFY HAVE_AVIF)
OCV_OPTION(
  WITH_CAP_IOS "Enable iOS video capture"
  ON
  VISIBLE_IF
  IOS
  VERIFY
...
OCV_OPTION(
  WITH_CPUFEATURES "Use cpufeatures Android library"
  ON
  VISIBLE_IF
  ANDROID
  VERIFY
...
OCV_OPTION(
  WITH_VTK "Include VTK library support (and build opencv_viz module eiher)"
  ON
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_NVCUVID "Include NVidia Video Decoding library support"
  ON
  VISIBLE_IF
  WITH_CUDA
  VERIFY
...
OCV_OPTION(
  WITH_NVCUVENC "Include NVidia Video Encoding library support"
  ON
  VISIBLE_IF
  WITH_CUDA
  VERIFY
...
OCV_OPTION(
  WITH_WAYLAND "Include Wayland support"
  OFF
  VISIBLE_IF
  UNIX
  AND
...
OCV_OPTION(
  WITH_HALIDE "Include Halide support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_VULKAN "Include Vulkan support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_OPENVINO "Include Intel OpenVINO toolkit support" (
  WITH_INF_ENGINE )
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_WEBNN "Include WebNN support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_JASPER "Include JPEG2K support (Jasper)"
  ON
  VISIBLE_IF
  NOT
  IOS
...
OCV_OPTION(
  WITH_OPENJPEG "Include JPEG2K support (OpenJPEG)"
  ON
  VISIBLE_IF
  NOT
  IOS
...
OCV_OPTION(WITH_JPEG "Include JPEG support" ON VISIBLE_IF TRUE VERIFY HAVE_JPEG)
OCV_OPTION(
  WITH_WEBP "Include WebP support"
  ON
  VISIBLE_IF
  NOT
  WINRT
...
OCV_OPTION(
  WITH_OPENEXR "Include ILM support via OpenEXR" ( (
  WIN32
  OR
  ANDROID
  OR
...
OCV_OPTION(
  WITH_OPENGL "Include OpenGL support"
  OFF
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_OPENVX "Include OpenVX support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_OPENNI "Include OpenNI support"
  OFF
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_OPENNI2 "Include OpenNI2 support"
  OFF
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(WITH_PNG "Include PNG support" ON VISIBLE_IF TRUE VERIFY HAVE_PNG)
OCV_OPTION(
  WITH_SPNG "Include SPNG support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_GDCM "Include DICOM support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_PVAPI "Include Prosilica GigE support"
  OFF
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_ARAVIS "Include Aravis GigE support"
  OFF
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_WIN32UI "Build with Win32 UI Backend support"
  ON
  VISIBLE_IF
  WIN32
  AND
...
OCV_OPTION(
  WITH_TBB "Include Intel TBB support"
  OFF
  VISIBLE_IF
  NOT
  IOS
...
OCV_OPTION(
  WITH_HPX "Include Ste||ar Group HPX support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_PTHREADS_PF "Use pthreads-based parallel_for"
  ON
  VISIBLE_IF
  NOT
  WIN32
...
OCV_OPTION(
  WITH_DSHOW "Build VideoIO with DirectShow support"
  ON
  VISIBLE_IF
  WIN32
  AND
...
OCV_OPTION(
  WITH_MSMF "Build VideoIO with Media Foundation support"
  NOT
  MINGW
  VISIBLE_IF
  WIN32
...
OCV_OPTION(
  WITH_MSMF_DXVA "Enable hardware acceleration in Media Foundation backend"
  WITH_MSMF
  VISIBLE_IF
  WIN32
  VERIFY
...
OCV_OPTION(
  WITH_UEYE "Include UEYE camera support"
  OFF
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_XINE "Include Xine support (GPL)"
  OFF
  VISIBLE_IF
  UNIX
  AND
...
OCV_OPTION(
  WITH_CLP "Include Clp support (EPL)"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_OPENCL "Include OpenCL Runtime support" (
  NOT
  ANDROID
  AND
  NOT
...
OCV_OPTION(
  WITH_OPENCL_SVM "Include OpenCL Shared Virtual Memory support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_OPENCLAMDFFT "Include AMD OpenCL FFT library support"
  ON
  VISIBLE_IF
  NOT
  ANDROID
...
OCV_OPTION(
  WITH_DIRECTX "Include DirectX support"
  ON
  VISIBLE_IF
  WIN32
  AND
...
OCV_OPTION(
  WITH_DIRECTML "Include DirectML support"
  ON
  VISIBLE_IF
  WIN32
  AND
...
OCV_OPTION(
  WITH_OPENCL_D3D11_NV "Include NVIDIA OpenCL D3D11 support"
  WITH_DIRECTX
  VISIBLE_IF
  WIN32
  AND
...
OCV_OPTION(
  WITH_VA_INTEL "Include Intel VA-API/OpenCL support" (
  X86_64
  OR
  X86 )
  VISIBLE_IF
...
OCV_OPTION(
  WITH_MFX "Include Intel Media SDK support"
  OFF
  VISIBLE_IF (
  UNIX
  AND
...
OCV_OPTION(
  WITH_GPHOTO2 "Include gPhoto2 library support"
  OFF
  VISIBLE_IF
  UNIX
  AND
...
OCV_OPTION(
  WITH_LAPACK "Include Lapack library support" (
  NOT
  CV_DISABLE_OPTIMIZATION )
  VISIBLE_IF
  NOT
...
OCV_OPTION(
  WITH_ITT "Include Intel ITT support"
  ON
  VISIBLE_IF
  NOT
  APPLE_FRAMEWORK
...
OCV_OPTION(
  WITH_IMGCODEC_HDR "Include HDR support"
  ON
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_IMGCODEC_SUNRASTER "Include SUNRASTER support"
  ON
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_IMGCODEC_PXM "Include PNM (PBM,PGM,PPM) and PAM formats support"
  ON
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_IMGCODEC_PFM "Include PFM formats support"
  ON
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_QUIRC "Include library QR-code decoding"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_ANDROID_MEDIANDK "Use Android Media NDK for Video I/O (Android)" (
  ...
  ANDROID
  VERIFY
  HAVE_ANDROID_MEDIANDK
)
OCV_OPTION(
  WITH_ANDROID_NATIVE_CAMERA "Use Android NDK for Camera I/O (Android)" (
  ANDROID_NATIVE_API_LEVEL
  GREATER
  23 )
  VISIBLE_IF
...
OCV_OPTION(
  WITH_ONNX "Include Microsoft ONNX Runtime support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_TIMVX "Include Tim-VX support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  WITH_OBSENSOR "Include obsensor support (Orbbec RGB-D modules: Astra+/Femto)"
  ON
  VISIBLE_IF (
  WIN32
  AND
...
OCV_OPTION(
  WITH_CANN "Include CANN support"
  OFF
  VISIBLE_IF
  TRUE
  VERIFY
...
OCV_OPTION(
  BUILD_ANDROID_PROJECTS "Build Android projects providing .apk files"
  ON
  IF
  ANDROID
)
OCV_OPTION(
  BUILD_ANDROID_EXAMPLES "Build examples for Android platform"
  ON
  IF
  ANDROID
)
...
OCV_OPTION(
  BUILD_PACKAGE "Enables 'make package_source' command"
  ON
  IF
  NOT
  WINRT
...
OCV_OPTION(
  BUILD_PERF_TESTS "Build performance tests"
  NOT
...
OCV_OPTION(
  BUILD_TESTS "Build accuracy & regression tests"
  NOT
  INSTALL_CREATE_DISTRIB
  IF (
  NOT
...
OCV_OPTION(
  BUILD_FAT_JAVA_LIB
  "Create Java wrapper exporting all functions of OpenCV library (requires static build of OpenCV modules)"
  ANDROID
  IF
  NOT
  BUILD_SHARED_LIBS
...
OCV_OPTION(
  BUILD_JAVA "Enable Java support" (
  ANDROID
  OR
  NOT
  CMAKE_CROSSCOMPILING )
...
OCV_OPTION(
  BUILD_KOTLIN_EXTENSIONS "Build Kotlin extensions (Android)"
  ON
  IF
  ANDROID
)
...
OCV_OPTION(
  INSTALL_BIN_EXAMPLES "Install prebuilt examples"
  WIN32
  IF
  BUILD_EXAMPLES
)
...
OCV_OPTION(
  ENABLE_PRECOMPILED_HEADERS "Use precompiled headers"
  MSVC
  IF (
  MSVC
  OR (
...
OCV_OPTION(
  ENABLE_DELAYLOAD "Enable delayed loading of OpenCV DLLs"
  OFF
  VISIBLE_IF
  MSVC
  AND
...
OCV_OPTION(
  ENABLE_SOLUTION_FOLDERS "Solution folder in Visual Studio or in other IDEs" (
  MSVC_IDE
  OR
  CMAKE_GENERATOR
  MATCHES Xcode )
...
OCV_OPTION(
  OPENCV_ENABLE_MEMORY_SANITIZER "Better support for memory/address sanitizers"
  OFF
)
OCV_OPTION(
  ENABLE_OMIT_FRAME_POINTER "Enable -fomit-frame-pointer for GCC"
  ON
  IF
  CV_GCC
)
OCV_OPTION(
  ENABLE_POWERPC "Enable PowerPC for GCC"
  ON
  IF (
  CV_GCC
  AND
...
if(
  ...
  ANDROID
  OR
  OPENCV_ANDROID_USE_LEGACY_FLAGS )
  AND
  CMAKE_CROSSCOMPILING
...
OCV_OPTION(
  ENABLE_IMPL_COLLECTION "Collect implementation data on function call"
  OFF
)
OCV_OPTION(
...
OCV_OPTION(
  ENABLE_GNU_STL_DEBUG "Enable GNU STL Debug mode (defines _GLIBCXX_DEBUG)"
  OFF
  IF
  CV_GCC
)
...
OCV_OPTION(
  GENERATE_ABI_DESCRIPTOR "Generate XML file for abi_compliance_checker tool"
  OFF
  IF
  UNIX
)
...
OCV_OPTION(
  OPENCV_GENERATE_SETUPVARS "Generate setup_vars* scripts"
  ON
  IF (
  NOT
  ANDROID
...
OCV_OPTION(
  OPENCV_DISABLE_THREAD_SUPPORT "Build the library without multi-threaded code."
  OFF
)
OCV_OPTION(
  OPENCV_SEMIHOSTING
  "Build the library for semihosting target (Arm). See https://developer.arm.com/documentation/100863/latest."
  OFF
)

OCV_OPTION(
  ENABLE_PYLINT "Add target with Pylint checks" (
  BUILD_DOCS
  OR
  BUILD_EXAMPLES )
  IF (
...
OCV_OPTION(
  ENABLE_FLAKE8 "Add target with Python flake8 checker" (
  BUILD_DOCS
  OR
  BUILD_EXAMPLES )
  IF (
...
set(
  ...
  CACHE
  STRING "URI to a MathJax installation"
)
...
set(
  ...
  CACHE
  PATH "Output directory for applications"
)
...
if(ANDROID)
  ...
  ocv_update(
    ...
    "${OpenCV_BINARY_DIR}/3rdparty/lib/${ANDROID_NDK_ABI_NAME}"
  )
else()
...
# ----------------------------------------------------------------------------
ocv_update(
  OPENCV_CONFIG_FILE_INCLUDE_DIR "${CMAKE_BINARY_DIR}/"
  CACHE
  PATH "Where to create the platform-dependant cvconfig.h"
)
...
if(UNIX OR MINGW)
  if(NOT APPLE_FRAMEWORK OR OPENCV_ENABLE_PKG_CONFIG)
    if(
      ...
      AND
      NOT
      DEFINED ENV{PKG_CONFIG_LIBDIR}
      AND
      NOT
      DEFINED ENV{PKG_CONFIG_SYSROOT_DIR}
      AND
      NOT
      OPENCV_ENABLE_PKG_CONFIG
    )
      ...
      elseif(OPENCV_SKIP_PKG_CONFIG_WARNING)
        message(
          WARNING
          "pkg-config is enabled in cross-compilation mode without defining of PKG_CONFIG_LIBDIR environment variable. This may lead to misconfigured host-based dependencies."
        )
      endif()
  ...
  if(FLAKE8_FOUND)
    ...
    if(NOT PYTHON3_VERSION_STRING VERSION_GREATER 3.6)
      ...
      list(
        APPEND
        OPENCV_FLAKE8_EXCLUDES
        "samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs"
      )
    endif()
    string(
      REPLACE ";" ","
      OPENCV_FLAKE8_EXCLUDES_STR "${OPENCV_FLAKE8_EXCLUDES}"
    )
    add_custom_target(
      check_flake8
      COMMAND
      ...
      .
      --count
      --select=E9,E901,E999,F821,F822,F823
      --show-source
      --statistics
      --exclude='${OPENCV_FLAKE8_EXCLUDES_STR}'
...
if(
  ...
  ANT_VERSION
  VERSION_GREATER 1.7 )
  AND ( ANDROID_TOOLS_Pkg_Revision
  GREATER
  13 )
)
...
foreach(hal ${OpenCV_HAL})
  if(hal STREQUAL "carotene")
    if(";${CPU_BASELINE_FINAL};" MATCHES ";NEON;")
      ...
      ocv_hal_register(
        CAROTENE_HAL_LIBRARIES
        CAROTENE_HAL_HEADERS
  ...
  elseif(hal STREQUAL "openvx")
    ...
    ocv_hal_register(
      OPENVX_HAL_LIBRARIES
      OPENVX_HAL_HEADERS
      OPENVX_HAL_INCLUDE_DIRS
    )
...
endforeach()
configure_file(
  "${OpenCV_SOURCE_DIR}/cmake/templates/custom_hal.hpp.in"
  "${OPENCV_CONFIG_FILE_INCLUDE_DIR}/custom_hal.hpp"
  @ONLY
)
unset(_hal_includes)
...
if(INSTALL_TESTS AND OPENCV_TEST_DATA_PATH)
  if(ANDROID)
    ...
    configure_file(
      "${CMAKE_CURRENT_SOURCE_DIR}/cmake/templates/opencv_run_all_tests_android.sh.in"
      "${CMAKE_BINARY_DIR}/unix-install/opencv_run_all_tests.sh"
      @ONLY
    )
    install(
      PROGRAMS "${CMAKE_BINARY_DIR}/unix-install/opencv_run_all_tests.sh"
      DESTINATION ./
      COMPONENT tests
    )
  elseif(WIN32)
    configure_file(
      "${CMAKE_CURRENT_SOURCE_DIR}/cmake/templates/opencv_run_all_tests_windows.cmd.in"
      "${CMAKE_BINARY_DIR}/win-install/opencv_run_all_tests.cmd"
      @ONLY
    )
    install(
      PROGRAMS "${CMAKE_BINARY_DIR}/win-install/opencv_run_all_tests.cmd"
      DESTINATION ${OPENCV_TEST_INSTALL_PATH}
      COMPONENT tests
    )
  elseif(UNIX)
    configure_file(
      "${CMAKE_CURRENT_SOURCE_DIR}/cmake/templates/opencv_run_all_tests_unix.sh.in"
      "${CMAKE_BINARY_DIR}/unix-install/opencv_run_all_tests.sh"
      @ONLY
    )
    install(
...
if(NOT OPENCV_README_FILE)
  if(ANDROID)
    set(
      OPENCV_README_FILE
      ${CMAKE_CURRENT_SOURCE_DIR}/platforms/android/README.android
    )
  endif()
endif()
...
if(COMMAND ocv_pylint_finalize)
  ...
  ocv_pylint_add_directory_recurse(
    ${CMAKE_CURRENT_LIST_DIR}/samples/python/tutorial_code
  )
  ocv_pylint_finalize()
endif()
if(TARGET check_pylint)
  message(
    STATUS
    "Registered 'check_pylint' target: using ${PYLINT_EXECUTABLE} (ver: ${PYLINT_VERSION}), checks: ${PYLINT_TOTAL_TARGETS}"
  )
endif()
if(TARGET check_flake8)
  message(
    STATUS
    "Registered 'check_flake8' target: using ${FLAKE8_EXECUTABLE} (ver: ${FLAKE8_VERSION})"
  )
endif()
...
status("")
status(
  "General configuration for OpenCV ${OPENCV_VERSION} ====================================="
)
...
status("")
status("  Platform:")
if(NOT DEFINED OPENCV_TIMESTAMP AND NOT BUILD_INFO_SKIP_TIMESTAMP)
  string(TIMESTAMP OPENCV_TIMESTAMP "" UTC)
  set(
    OPENCV_TIMESTAMP "${OPENCV_TIMESTAMP}"
    CACHE
    STRING "Timestamp of OpenCV build configuration"
    FORCE
  )
endif()
if(OPENCV_TIMESTAMP)
...
if(CPU_DISPATCH_FINAL OR CPU_DISPATCH)
  ...
  foreach(OPT ${CPU_DISPATCH_FINAL})
    status(
      "      ${OPT} (${CPU_${OPT}_USAGE_COUNT} files):"
...
status(
  "    Precompiled headers:" PCHSupport_FOUND
  AND
...
foreach(the_module ${OPENCV_MODULES_BUILD})
  if(
    NOT OPENCV_MODULE_${the_module}_CLASS
    STREQUAL "INTERNAL"
    OR the_module
    STREQUAL "opencv_ts"
  )
...
string(
  REPLACE "opencv_" ""
  OPENCV_MODULES_BUILD_ST "${OPENCV_MODULES_BUILD_ST}"
)
string(
  REPLACE "opencv_" ""
  OPENCV_MODULES_DISABLED_USER_ST "${OPENCV_MODULES_DISABLED_USER}"
)
string(
  REPLACE "opencv_" ""
  OPENCV_MODULES_DISABLED_AUTO_ST "${OPENCV_MODULES_DISABLED_AUTO}"
)
string(
  REPLACE "opencv_" ""
  OPENCV_MODULES_DISABLED_FORCE_ST "${OPENCV_MODULES_DISABLED_FORCE}"
)
...
status(
  ...
  THEN ${OPENCV_MODULES_BUILD_ST}
  ELSE "-"
)
status(
  "    Disabled:"
  OPENCV_MODULES_DISABLED_USER
  THEN ${OPENCV_MODULES_DISABLED_USER_ST}
  ELSE "-"
)
status(
  "    Disabled by dependency:"
  OPENCV_MODULES_DISABLED_AUTO
  THEN ${OPENCV_MODULES_DISABLED_AUTO_ST}
  ELSE "-"
)
status(
  "    Unavailable:"
...
ocv_build_features_string(
  ...
  THEN "doxygen"
  IF
  TARGET doxygen_python
  THEN "python"
  IF
  TARGET doxygen_javadoc
  THEN "javadoc"
  IF BUILD_opencv_js
  OR
  DEFINED
...
if(ANDROID)
  ...
  if(BUILD_ANDROID_PROJECTS)
    status(
      "  Android SDK: "
      "${ANDROID_SDK} (tools: ${ANDROID_SDK_TOOLS_VERSION} build tools: ${ANDROID_SDK_BUILD_TOOLS_VERSION})"
    )
...
if(WITH_QT OR HAVE_QT)
  if(HAVE_QT)
    status(
      "    QT:"
      "YES (ver ${QT_VERSION_MAJOR}.${QT_VERSION_MINOR}.${QT_VERSION_PATCH} ${QT_EDITION})"
    )
    if(HAVE_QT_OPENGL)
      if(Qt${QT_VERSION_MAJOR}OpenGL_LIBRARIES)
        status(
          ...
          HAVE_QT_OPENGL
          THEN
          "YES (${Qt${QT_VERSION_MAJOR}OpenGL_LIBRARIES} ${Qt${QT_VERSION_MAJOR}OpenGL_VERSION_STRING})"
          ELSE
          NO
        )
      else()
...
status(
  "    ZLib:"
  ZLIB_FOUND
  THEN "${ZLIB_LIBRARIES} (ver ${ZLIB_VERSION_STRING})"
  ELSE "build (ver ${ZLIB_VERSION_STRING})"
)
...
if(WITH_WEBP OR HAVE_WEBP)
  status(
    "    WEBP:"
    WEBP_FOUND
    THEN "${WEBP_LIBRARY} (ver ${WEBP_VERSION})"
    ELSE "build (ver ${WEBP_VERSION})"
  )
endif()
...
if(WITH_AVIF OR HAVE_AVIF)
  if(AVIF_VERSION)
    status(
      "    AVIF:"
      AVIF_FOUND
      THEN "${AVIF_LIBRARY} (ver ${AVIF_VERSION})"
      ELSE "NO"
    )
  else()
...
if(WITH_PNG OR HAVE_PNG OR WITH_SPNG)
  if(WITH_SPNG)
    ...
    status(
      "    PNG:"
      PNG_FOUND
      THEN "${PNG_LIBRARY} (ver ${PNG_VERSION})"
      ELSE "build (ver ${PNG_VERSION})"
    )
  endif()
endif()
...
if(WITH_TIFF OR HAVE_TIFF)
  status(
    "    TIFF:"
    TIFF_FOUND
    THEN "${TIFF_LIBRARY} (ver ${TIFF_VERSION} / ${TIFF_VERSION_STRING})"
    ELSE "build (ver ${TIFF_VERSION} - ${TIFF_VERSION_STRING})"
  )
endif()

if(HAVE_OPENJPEG)
  status(
    "    JPEG 2000:" OpenJPEG_FOUND
    THEN
    "OpenJPEG (ver ${OPENJPEG_MAJOR_VERSION}.${OPENJPEG_MINOR_VERSION}.${OPENJPEG_BUILD_VERSION})"
...
elseif(HAVE_JASPER)
  status(
    "    JPEG 2000:"
    JASPER_FOUND
    THEN "${JASPER_LIBRARY} (ver ${JASPER_VERSION_STRING})"
    ELSE "build Jasper (ver ${JASPER_VERSION_STRING})"
  )
...
if(WITH_OPENEXR OR HAVE_OPENEXR)
  if(HAVE_OPENEXR)
    status(
      "    OpenEXR:"
      OPENEXR_FOUND
      THEN "${OPENEXR_LIBRARIES} (ver ${OPENEXR_VERSION})"
      ELSE "build (ver ${OPENEXR_VERSION})"
    )
  else()
    status("    OpenEXR:" "NO")
  endif()
...
if(WITH_FFMPEG OR HAVE_FFMPEG)
  if(OPENCV_FFMPEG_USE_FIND_PACKAGE)
    status(
      "    FFMPEG:"
      HAVE_FFMPEG
      THEN "YES (find_package)"
      ELSE "NO (find_package)"
    )
  elseif(WIN32)
  ...
  status(
    ...
    THEN "YES (${FFMPEG_libavcodec_VERSION})"
    ELSE
    NO
  )
  status(
    "      avformat:" FFMPEG_libavformat_VERSION
    THEN "YES (${FFMPEG_libavformat_VERSION})"
    ELSE
    NO
  )
  status(
    "      avutil:" FFMPEG_libavutil_VERSION
    THEN "YES (${FFMPEG_libavutil_VERSION})"
    ELSE
    NO
  )
  status(
    "      swscale:" FFMPEG_libswscale_VERSION
    THEN "YES (${FFMPEG_libswscale_VERSION})"
    ELSE
    NO
  )
  status(
    "      avresample:" FFMPEG_libavresample_VERSION
    THEN "YES (${FFMPEG_libavresample_VERSION})"
    ELSE
    NO
  )
  if(OPENCV_FFMPEG_ENABLE_LIBAVDEVICE)
    status(
      "      avdevice:" FFMPEG_libavdevice_VERSION
      THEN "YES (${FFMPEG_libavdevice_VERSION})"
      ELSE
      NO
    )
  endif()
...
ocv_build_features_string(
  ...
  HAVE_TBB
  THEN
  "TBB (ver ${TBB_VERSION_MAJOR}.${TBB_VERSION_MINOR} interface ${TBB_INTERFACE_VERSION})"
  IF
  HAVE_HPX
  THEN "HPX"
  IF
...
if(WITH_IPP AND HAVE_IPP)
  status(
    "    Intel IPP:"
    "${IPP_VERSION_STR} [${IPP_VERSION_MAJOR}.${IPP_VERSION_MINOR}.${IPP_VERSION_BUILD}]"
  )
  ...
  if(HAVE_IPP_IW)
    if(BUILD_IPP_IW)
      status(
        "    Intel IPP IW:"
        "sources (${IW_VERSION_MAJOR}.${IW_VERSION_MINOR}.${IW_VERSION_UPDATE})"
      )
    else()
      status(
        "    Intel IPP IW:"
        "binaries (${IW_VERSION_MAJOR}.${IW_VERSION_MINOR}.${IW_VERSION_UPDATE})"
      )
    endif()
...
if(WITH_HALIDE OR HAVE_HALIDE)
  status(
    "    Halide:"
    HAVE_HALIDE
    THEN "YES (${HALIDE_LIBRARIES} ${HALIDE_INCLUDE_DIRS})"
    ELSE
    NO
  )
endif()
  ...
  if(WITH_INF_ENGINE OR INF_ENGINE_TARGET)
    if(INF_ENGINE_TARGET)
      ...
      ocv_build_features_string(
        ...
        IF _lib_imp_rel
        AND _lib_imp_dbg
        THEN "${_lib_imp_rel} / ${_lib_imp_dbg}"
        IF _lib_rel
        AND _lib_dbg
        THEN "${_lib_rel} / ${_lib_dbg}"
        IF _lib_rel
        THEN "${_lib_rel}"
        IF _lib_dbg
        THEN "${_lib_dbg}"
...
if(WITH_EIGEN OR HAVE_EIGEN)
  status(
    ...
    HAVE_EIGEN
    THEN
    "YES (ver ${EIGEN_WORLD_VERSION}.${EIGEN_MAJOR_VERSION}.${EIGEN_MINOR_VERSION})"
    ELSE
    NO
  )
endif()
...
status(
  "    Custom HAL:" OpenCV_USED_HAL
  THEN "YES (${OpenCV_USED_HAL})"
  ELSE "NO"
)
...
if(WITH_CUDA OR HAVE_CUDA)
  ...
  status(
    "  NVIDIA CUDA:"
    HAVE_CUDA
    THEN "YES (ver ${CUDA_VERSION_STRING}, ${cuda_features})"
    ELSE
    NO
  )
  if(HAVE_CUDA)
...
if(WITH_VULKAN OR HAVE_VULKAN)
  ...
  if(HAVE_VULKAN)
    status(
      "    Include path:"
      VULKAN_INCLUDE_DIRS
      THEN "${VULKAN_INCLUDE_DIRS}"
      ELSE "NO"
    )
    status(
      "    Link libraries:"
      VULKAN_LIBRARIES
      THEN "${VULKAN_LIBRARIES}"
      ELSE "Dynamic load"
    )
  endif()
endif()
...
if(WITH_OPENCL OR HAVE_OPENCL)
  ...
  if(HAVE_OPENCL)
    status(
      "    Include path:"
      OPENCL_INCLUDE_DIRS
      THEN "${OPENCL_INCLUDE_DIRS}"
      ELSE "NO"
    )
    status(
      "    Link libraries:"
      OPENCL_LIBRARIES
      THEN "${OPENCL_LIBRARIES}"
      ELSE "Dynamic load"
    )
  endif()
endif()
...
if(BUILD_opencv_python2)
  ...
  status(
    "    Interpreter:"
    PYTHON2INTERP_FOUND
    THEN "${PYTHON2_EXECUTABLE} (ver ${PYTHON2_VERSION_STRING})"
    ELSE
    NO
  )
  if(PYTHON2LIBS_VERSION_STRING)
    status(
      "    Libraries:" HAVE_opencv_python2
      THEN "${PYTHON2_LIBRARIES} (ver ${PYTHON2LIBS_VERSION_STRING})"
      ELSE
      NO
    )
  else()
  ...
  status(
    ...
    THEN "${PYTHON2_NUMPY_INCLUDE_DIRS} (ver ${PYTHON2_NUMPY_VERSION})"
    ELSE "NO (Python wrappers can not be generated)"
  )
  status(
    "    install path:" HAVE_opencv_python2
    THEN "${__INSTALL_PATH_PYTHON2}"
    ELSE "-"
  )
endif()
...
if(BUILD_opencv_python3)
  ...
  status(
    "    Interpreter:"
    PYTHON3INTERP_FOUND
    THEN "${PYTHON3_EXECUTABLE} (ver ${PYTHON3_VERSION_STRING})"
    ELSE
    NO
  )
  if(PYTHON3LIBS_VERSION_STRING)
    status(
      "    Libraries:" HAVE_opencv_python3
      THEN "${PYTHON3_LIBRARIES} (ver ${PYTHON3LIBS_VERSION_STRING})"
      ELSE
      NO
    )
  else()
  ...
  status(
    ...
    THEN "${PYTHON3_NUMPY_INCLUDE_DIRS} (ver ${PYTHON3_NUMPY_VERSION})"
    ELSE "NO (Python3 wrappers can not be generated)"
  )
  status(
    "    install path:" HAVE_opencv_python3
    THEN "${__INSTALL_PATH_PYTHON3}"
    ELSE "-"
  )
endif()
...
status(
  ...
  THEN "${PYTHON_DEFAULT_EXECUTABLE}"
  ELSE
  NO
)
...
if(BUILD_JAVA)
  ...
  status(
    "    ant:"
    ANT_EXECUTABLE
    THEN "${ANT_EXECUTABLE} (ver ${ANT_VERSION})"
    ELSE
    NO
  )
  if(NOT ANDROID)
  ...
  status(
    "    Java wrappers:" HAVE_opencv_java
    THEN "YES (${OPENCV_JAVA_SDK_BUILD_TYPE})"
    ELSE
    NO
  )
  status(
    "    Java tests:"
    BUILD_TESTS
    AND opencv_test_java_BINARY_DIR
    THEN
    YES
    ELSE
    NO
